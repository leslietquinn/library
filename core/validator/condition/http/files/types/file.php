<?php
	...
	final class QValidator_Condition_Http_Files_Types extends QValidator_Condition {
		private $field_name;
		private $filetypes;
		private $message;
		 ...
		 *
		 * @see		./qvalidator/condition/http/files/upload/filetypes/
		 *
		 * @access				public
		 * @return				void
		 */
		...
		public function isValid( QDataspace_Interface $dataspace, $logger ) {
			$extension = QCommon::fileExtension( $dataspace -> get( $this -> field_name ) );
