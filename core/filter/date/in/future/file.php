<?php
	...
	final class QFilter_Date_In_Future implements QFilter_Interface {
		private $use_present;
		private $field_name;
		private $how_far;
		private $format;
		...
		/** 
		 * Find and format a date in the future
		 *
		 * @param	$field_name		string
		 * @param 	$how_far		int		  		how far in the future, in seconds
		 * @param  	$use_present  	bool	  		true or false
